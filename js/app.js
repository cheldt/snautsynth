...
requirejs(['app/event/Event', 'app/canvas/CanvasState',
    ...
    function (Event, CanvasState, Knob, RadioGroup,
              ...
              NumberFormatter, Label, GlobalConstants, EnvelopeGraph, EnvelopePoint, NumberRange) {
        ...
        canvasState.addControl(new Knob(GlobalConstants.CTRL_OSC1_TUNE, 60, 20, 0, canvasState, 1, new NumberRange(-12, 12), 50,'#AABBCC', 0, 0.5, 0, new NumberFormatter('#0')));
        canvasState.addControl(new Label(1, 130, 20, canvasState, '#000', 'OSC1-Tune'));

        canvasState.addControl(new Knob(GlobalConstants.CTRL_OSC1_OCT, 120, 20, 0, canvasState, 1, new NumberRange(-4, 4), 50,'#AABBCC', 1, 0.5, 0, new NumberFormatter('#0')));
        canvasState.addControl(new Label(1, 250, 20, canvasState, '#000', 'OSC1-Octave'));

        canvasState.addControl(new Knob(GlobalConstants.CTRL_OSC1_GAIN, 180, 20, 1, canvasState, 100, new NumberRange(0, 1), 50,'#AABBCC', 0, 0, null, new NumberFormatter('#0.0')));
        ...
        canvasState.addControl(new Knob(GlobalConstants.CTRL_OSC2_TUNE, 60, 100, 0, canvasState, 1, new NumberRange(-12, 12), 50,'#AABBCC', 0, 0.5, 0, new NumberFormatter('#0')));
        canvasState.addControl(new Label(1, 130, 180, canvasState, '#000', 'OSC1-Tune'));

        canvasState.addControl(new Knob(GlobalConstants.CTRL_OSC2_OCT, 120, 100, 0, canvasState, 1, new NumberRange(-4, 4), 50,'#AABBCC', 1, 0.5, 0, new NumberFormatter('#0')));
        canvasState.addControl(new Label(1, 250, 180, canvasState, '#000', 'OSC1-Octave'));

        canvasState.addControl(new Knob(GlobalConstants.CTRL_OSC2_GAIN, 180, 100, 1, canvasState, 100, new NumberRange(0, 1), 50,'#AABBCC', 0, 0, null, new NumberFormatter('#0.0')));
        canvasState.addControl(new Label(1, 370, 180, canvasState, '#000', 'OSC1-Gain'));

        canvasState.addControl(new Knob(GlobalConstants.CTRL_MASTERGAIN, 240, 60, 0.5, canvasState, 100, new NumberRange(0, 0.5), 50,'#AABBCC', 0, 0, null, new NumberFormatter('#0.0')));
        ...
        canvasState.addControl(new Fader(GlobalConstants.CTRL_FLT_FREQUENCY, 450, 370, 22050, canvasState, 1, new NumberRange(60, 22050), 100, '#AABBCC', 0, 0, 0, new NumberFormatter('#0'), Fader.ORIENTATION_VERTICAL));

        canvasState.addControl(new Label(1, 530, 340, canvasState, '#000', 'Res'));
        canvasState.addControl(new Fader(GlobalConstants.CTRL_FLT_RESONANCE, 530, 370, 0.0001, canvasState, 1, new NumberRange(0.0001, 50), 100, '#AABBCC', 0, 0, 0, new NumberFormatter('#0'), Fader.ORIENTATION_VERTICAL));
